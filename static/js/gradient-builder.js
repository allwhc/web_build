// Complete Gradient Builder Integration - Add this to main.js or create gradient-builder.js
...
// Gradient Builder CSS - Auto-inject styles
function injectGradientBuilderStyles() {
    const existingStyle = document.getElementById('gradient-builder-styles');
    if (existingStyle) return; // Already injected

    const style = document.createElement('style');
    style.id = 'gradient-builder-styles';
    style.textContent = `
...
// Gradient Builder HTML - Auto-inject modal
function injectGradientBuilderHTML() {
    const existingModal = document.getElementById('gradientBuilderModal');
    if (existingModal) return; // Already injected

    const modalHTML = `
        <div class="gradient-builder-modal" id="gradientBuilderModal">
                        ...
                        <div class="gradient-controls-left">
                            ...
                            <div class="gradient-control-group">
                                ...
                                <div class="direction-buttons">
                                    ...
                                    <button class="direction-btn" onclick="setGradientDirection('to top right')">↗ TR</button>
                                    <button class="direction-btn" onclick="setGradientDirection('to right')">→ Right</button>
                                    <button class="direction-btn" onclick="setGradientDirection('to bottom right')">↘ BR</button>
                                    <button class="direction-btn" onclick="setGradientDirection('to bottom')">↓ Bottom</button>
                                    <button class="direction-btn" onclick="setGradientDirection('to bottom left')">↙ BL</button>
                                    <button class="direction-btn" onclick="setGradientDirection('to left')">← Left</button>
                                    <button class="direction-btn" onclick="setGradientDirection('to top left')">↖ TL</button>
...
function initializeGradientBuilder() {
    injectGradientBuilderStyles();
    injectGradientBuilderHTML();
    console.log('🎨 Gradient Builder initialized successfully!');
}
...
function applyGradientToHero() {
    ...
    if (heroBackgroundInput) {
        ...
        // Update hero preview if function exists
        if (typeof updateHeroPreview === 'function') {
            updateHeroPreview();
        }

        // Save configuration if function exists
...
// Quick gradient application (for main admin panel)
function applyQuickGradient(gradient) {
    ...
    if (heroBackground) {
        ...
        if (typeof updateGradientPreviewMini === 'function') {
...
function setupGradientBuilderKeyboardShortcuts() {
...
function initializeGradientBuilderComplete() {
    // Wait for DOM to be fully loaded
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', function() {
            initializeGradientBuilder();
            setupGradientBuilderKeyboardShortcuts();
        });
    } else {
...
// Auto-initialize
initializeGradientBuilderComplete();
...
window.applyQuickGradient = applyQuickGradient;
window.applyQuickTextColor = applyQuickTextColor;
window.autoContrastColor = autoContrastColor;
window.updateGradientPreviewMini = updateGradientPreviewMini;
window.updateHeroPreview = updateHeroPreview;

console.log('🎨 Complete Gradient Builder loaded successfully!');